...
<head>
    ...
    <title>Detalles de Reservas - Panel</title>
    <!-- Bootstrap CSS -->
...
<body class="bg-dark text-light">
    <div class="dark-mode d-flex">
        ...
        <div class="main-content flex-grow-1 p-4">
            ...
            <!-- Encabezado -->
            <div class="mb-4">
                <h2><i class="bi bi-card-checklist me-2"></i>Detalles de Reservas</h2>
                <p>Administra todos los detalles de las reservas realizadas</p>
            </div>

            <!-- Tarjeta Detalles -->
            <div class="card card-shadow">
                <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <h5 class="mb-0"><i class="bi bi-list-ul me-2"></i>Listado de Detalles</h5>
                    <button type="button" class="btn btn-success btn-sm btn-lg shadow" data-bs-toggle="modal"
                        data-bs-target="#modalAgregar">
                        <i class="bi bi-plus-circle-fill me-2"></i>Nuevo Detalle
                    </button>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
                        <div>
                            <h6 class="text-white mb-1">Total de detalles</h6>
                        ...
                        <table class="table table-hover align-middle text-center table-usuarios w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $detalle['asiento_id'] ?></td>
                                    <td><?= $detalle['reserva_id'] ?></td>
                                    <td><?= $detalle['precio_unitario'] ?></td>
                                    <td><?= $detalle['numero_ticket'] ?></td>
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a href="<?= base_url('buscar_detalles_reservas/'.$detalle['detalle_id']) ?>"
                                                class="btn btn-info btn-sm" title="Editar">
                                                <i class="bi bi-pencil-fill"></i>
                                            </a>
                                            <a href="<?= base_url('eliminar_detalles_reservas/'.$detalle['detalle_id']) ?>"
                    ...
                    <div class="modal-content">
                        <div class="modal-header bg-gradient"
                            ...
                            <h5 class="modal-title" id="modalAgregarLabel"><i
                                    class="bi bi-plus-circle-fill me-2"></i>Agregar Nuevo Detalle</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                aria-label="Cerrar"></button>
                        </div>
                        <div class="modal-body">
                            <form action="<?= base_url('agregar_detalles_reservas') ?>" method="post">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="number" name="txt_reserva" id="txt_reserva" class="form-control"
                                            required>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label for="txt_ticket" class="form-label">Número Ticket</label>
                                        <input type="number" name="txt_ticket" id="txt_ticket" class="form-control"
                                            required>
                                    </div>
                                </div>
