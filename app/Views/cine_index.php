...
<div class="shooting-star"></div>
  ...
  <nav class="navbar navbar-expand-lg navbar-custom">
    ...
    <div class="img-estreno">
      <img  src="https://i.ibb.co/39t0n54H/estreno.png" class="animate__animated animate__fadeInDown" alt="Estreno" class="header-image" width="100%">
    </div>
    ...
    <div class="display">
      <div class="scriptin">
        <p>funcion bonita para mostrar pelis aca</p>
      </div>
